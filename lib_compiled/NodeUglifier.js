...
(function() {
  ...
  NodeUglifier = (function() {
    function NodeUglifier(mainFile, options) {
      ...
      this.getRequireSubstitutionForFilteredWithExport = __bind(this.getRequireSubstitutionForFilteredWithExport, this);
      this.getNewRelativePathForFiltered = __bind(this.getNewRelativePathForFiltered, this);
      this.getNewRelativePathForFilteredWithExport = __bind(this.getNewRelativePathForFilteredWithExport, this);
      this.options = {
        mergeFileFilterWithExport: [],
        mergeFileFilter: [],
